`Databox.lua` is the main Module code for the Wikidata module "Databox", stored at https://www.wikidata.org/wiki/Module:Databox or in the clients, e.g. https://fr.wikipedia.org/wiki/Module:Databox
